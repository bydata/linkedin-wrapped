...
```{r post-calender, fig.align='center', fig.width=6, fig.height=3, fig.retina=TRUE, fig.dpi=200}
...
```{r posts-per-month, fig.height=2.5, fig.align='center'}
df_post_stats |> 
  group_by(month) |> 
  summarize(n_posts = n()) |> 
...
```{r posts-engagements-per-month, fig.height=2.5, fig.align='center'}
df_post_stats |> 
  group_by(month) |> 
