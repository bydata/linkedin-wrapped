...
\begin{center}
\fontsize{24}{6}\selectfont Your top posts in 2024
\end{center}
\vspace{-10mm}
\begin{center}
...
df_post_stats |> 
 ...
 ggplot() +
  ...
  theme_void() +
  theme(
    strip.text = element_text(size = 24, face = "bold", color = "white", vjust = 1)
  )
```
...
\begin{center}
\fontsize{24}{6}\selectfont Your top posts in 2024 per month
\end{center}
\vspace{-10mm}
\begin{center}
\fontsize{12}{6}\selectfont (by number of reactions)
...
```{r top-posts-per-month, fig.width=7, fig.height=5}
...
df_post_stats |> 
 ...
 ggplot() +
  ...
  theme_void() +
  theme(
    strip.text = element_text(size = 16, face = "bold", color = "white", vjust = 1)
  )
